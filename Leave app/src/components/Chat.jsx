    ...
    <>
      <section id="inbox">
        <div className="p-4 sm:ml-64">
          <div className="p-4 h-[87vh] border-2 border-[#4a9dc9] border-dashed rounded-lg dark:border-gray-700 mt-16">
            <h1 className="text-3xl py-3 pl-4">Chat</h1>
            <div className="flex ">
              <div className="w-[30%] border-r h-[77vh]">
